import os
os.system("pip install fake_useragent requests mechanize rich")
import requests
import time
import sys
import webbrowser
...
to(
    f"""{G}|{C}=============================================={G}|
{G}| Creator        : @Haxkx & @toxic_hanzala {G}         |
...
Ya_Bs = '\033[1;34m'
S_aBs = '\033[1;33m'
ab = pyfiglet.figlet_format("Hanzala")
print(a_bSa+ab)
def slow(T): 
	for r in T + '\n' :
	    sys.stdout.write(r)
...
slow(S_aBs+"""⌯ Welcome To hanzala Safeum Account Creater  💘.
---------------------------------------------------
""")
webbrowser.open("https://t.me/hanzala")
